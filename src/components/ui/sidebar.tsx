...
// const SIDEBAR_WIDTH_MOBILE = "18rem" // Used for mobile sidebar width
    ...
    if (isMobile) {
      return (
        <div className="fixed inset-0 z-50 md:hidden">
          ...
          <div
            className={cn(
              "fixed left-0 top-0 h-full w-[--sidebar-width-mobile] bg-sidebar text-sidebar-foreground shadow-lg transition-transform",
      ...
      >
        ...
        <div
          className={cn(
            ...
            variant === "floating" || variant === "inset"
              ? "p-2 group-data-[state=collapsed]:w-[--sidebar-width-icon]"

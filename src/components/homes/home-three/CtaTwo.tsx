            ...
            <div className="col-lg-12">
               <div className="tg-banner-2-content text-center">
                   <div className="tg-about-section-title mb-25">
                      <h5 className="tg-section-subtitle mb-10 wow fadeInUp" data-wow-delay=".4s" data-wow-duration=".9s">Next Adventure in Suriname</h5>
                      <h2 className="tg-section-title-white mb-25 wow fadeInUp" data-wow-delay=".5s" data-wow-duration=".9s">Authentic Travel Destinations <br />in Suriname</h2>
                   </div>
                   <div className="tp-banner-btn-wrap wow fadeInUp" data-wow-delay=".6s" data-wow-duration=".9s">
                      <Link to="/tours" className="tg-btn tg-btn-transparent tg-btn-switch-animation">
                         <Button text="Discover Suriname Tours" />
                      </Link>
                   </div>
               </div>
            </div>

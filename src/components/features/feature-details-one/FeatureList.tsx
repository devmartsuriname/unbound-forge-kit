...
const FeatureList = ({ tour }: FeatureListProps) => {
   ...
   const tourFeatures: DataType[] = [
      ...
      },
      {
         ...
         sub_title: "Difficulty",
         title: tour.difficulty_level.charAt(0).toUpperCase() + tour.difficulty_level.slice(1),
      },
      {
         id: 3,
         icon: (<><svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
         ...
         title: `${tour.max_participants} People`,
      },
      {
         id: 4,
